...
int adj_matrix_root1[10][10];
int adj_matrix_root2[10][10];
...
void *func() {
	...
	set_node1(n5, n1);
	adj_matrix_root1[n5->value - 1][n1->value - 1] = 1;
	
	Node *n2 = node(2, NULL, NULL, NULL);
	n1->node1 = n2;
	set_node1(n1, n2);
	adj_matrix_root1[n1->value - 1][n2->value - 1] = 1;
	adj_matrix_root2[n1->value - 1][n2->value - 1] = 1;
	...
	n1->node2 = n9;
	set_node2(n1, n9);
	adj_matrix_root1[n1->value - 1][n9->value - 1] = 1;
	adj_matrix_root2[n1->value - 1][n9->value - 1] = 1;
	...
	n1->node3 = n10;
	set_node3(n1, n10);
	adj_matrix_root1[n1->value - 1][n10->value - 1] = 1;
	adj_matrix_root2[n1->value - 1][n10->value - 1] = 1;
...
main(){
    ...
    for(int i=0; i<10; i++){
    	for(int j=0; j<10; j++){
    		adj_matrix_root1[i][i] = 0;
		}
	}
	
	for(int i=0; i<10; i++){
    	for(int j=0; j<10; j++){
    		adj_matrix_root2[i][i] = 0;
		}
	}
